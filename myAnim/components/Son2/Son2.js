...
export default class Son2 extends Component {
    constructor() {
        ...
        this.state = {
            colors: [
                { title: 'Title1', description: 'Description1', renk: 'green', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title2', description: 'Description2', renk: 'blue', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title3', description: 'Description3', renk: 'red', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title4', description: 'Description4', renk: 'orange', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title5', description: 'Description5', renk: 'yellow', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title6', description: 'Description6', renk: 'purple', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title7', description: 'Description7', renk: 'green', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title8', description: 'Description8', renk: 'blue', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title9', description: 'Description9', renk: 'red', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title10', description: 'Description10', renk: 'orange', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title11', description: 'Description11', renk: 'yellow', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
                { title: 'Title12', description: 'Description12', renk: 'purple', margin_bottom_renk: MARGIN_BOTTOM_RENK, margin_top_renk: MARGIN_TOP_RENK, item_height: ITEM_HEIGHT, item_width: ITEM_WIDTH },
    ...
    tiklanma(index) {
        ...
        //Yalanci title size
        const fontSizeTitle = this.animValue.interpolate({
            inputRange: [0, 0.9, 1],
            outputRange: [50, 50, 0]
        })
        //Yalanci desc size
        const fontSizeDesc = this.animValue.interpolate({
            inputRange: [0, 0.9, 1],
            outputRange: [20, 20, 0]
        })
        //Yalanci buton height
        const buttonHeight = this.animValue.interpolate({
            inputRange: [0, 0.9, 1],
            outputRange: [30, 30, 0]
        })
        //hareket eden view
        yalanci = <Animated.View style={{
            ...
            <TouchableOpacity style={{ height: buttonHeight, backgroundColor: '#EEE4E2' }}><Animated.Text style={{ fontSize: fontSizeDesc }}>Press Me</Animated.Text></TouchableOpacity>
        </Animated.View>
    }
        ...
        colorDetails = temp.map((item, i) => {
            return <TouchableOpacity key={i} activeOpacity={0.8}
                ...
                <Animated.View
                    ...
                    <TouchableOpacity style={{ height: 30, backgroundColor: '#EEE4E2' }}><Animated.Text style={{ fontSize: 20 }}>{this.props.description}</Animated.Text></TouchableOpacity>
                </Animated.View>
            </TouchableOpacity>
        })
